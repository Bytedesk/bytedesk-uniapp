...
- 然后：在pages.json中添加此以下几个页面，具体可参考demo中pages.json文件
...
```js
// 针对vue3项目，请参考项目 bytedesk_demo_v3
// 将 bytedesk_demo_v3/componets/bytedesk_kefu 拷贝到自己项目 components 文件夹
// 在项目根目录下添加 moment 组件
yarn init -y
yarn add moment @stomp/stompjs
// 或
npm init -y
npm install -S moment @stomp/stompjs
```
