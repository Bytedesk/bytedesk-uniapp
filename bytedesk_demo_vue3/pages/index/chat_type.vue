...
export default {
	...
	methods: {
		...
		startH5Chat () {
			// 如果不想集成SDK，也可以直接集成H5页面即可，其余操作均可忽略，只需一步集成H5链接即可 
			// 登录管理后台：https://www.weiyuai.cn/admin，客服管理-》技能组-》获取组客服代码
		...
		// 	let url = "https://uni.okxkf.com/chat/h5/video.html?sub=vip&uid=201808221551193&sid=201807171659201&type=1&hidenav=1&ph=ph";
		// 	uni.navigateTo({
		// 		url:"../../components/bytedesk_sdk/webview?url=" + encodeURIComponent(url)
		// 	})
		// },
		...
		// 	// page: components/bytedesk_sdk/chat-scan
		// 	uni.navigateTo({
		// 		url: '../../components/bytedesk_sdk/chat-scan?scan=w17'
		// 	});
		// },
		// TODO内测中: 小程序码客服-指定客服
		...
		// 	// page: components/bytedesk_sdk/chat-scan
		// 	uni.navigateTo({
		// 		url: '../../components/bytedesk_sdk/chat-scan?scan=a15'
		// 	});
		// },
		// 访客端-查询访客所有未读消息数目
