...
<script>
	...
	export default {
		props:{
			...
			headPicValue:{
				type:String,
				default:require('@/components/bytedesk_sdk/image/rate/rate_pic.png')
			},
			headTitleShow:{ //标题
				type:[String,Boolean],
				default:true,
			...
			starDefault:{ //未选中
				type:String,
				default:require('@/components/bytedesk_sdk/image/rate/rate_star.png'),
			},
			starActive:{
				type:String,
				default:require('@/components/bytedesk_sdk/image/rate/rate_star_active.png'),
			},
			score:{  //默认分数
				type:[Number,String],
				default:5
