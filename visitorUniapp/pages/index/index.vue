	...
	data() {
		return {
			...
			orderInfoDemo: {
				type: 'order',
				title: '轻奢通勤双肩包订单',
				description: '演示订单卡片，字段结构与后端 OrderEntity 对齐。',
				state: 'paid',
				...
				status: 'paid',
				statusText: '待发货',
				orderUid: 'order_uniapp_001',
				orderTitle: '轻奢通勤双肩包',
				orderImage: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?auto=format&fit=crop&w=900&q=80',
				orderDescription: '适合日常通勤和短途出差的多功能双肩包。',
				orderPrice: 399,
				orderUrl: 'https://www.weiyuai.cn',
				orderTagList: ['新品', '包邮'],
				// orderExtra: JSON.stringify({
				// 	source: 'visitor-uniapp-demo',
				// 	scene: 'order-goods',
				// 	note: 'flat order goods snapshot'
				// }),
				orderQuantity: 1,
				totalAmount: 399,
				shippingAddress: {
