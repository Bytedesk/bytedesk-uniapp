  ...
  <view class="bytedesk">
    ...
    <uni-list :border="true">
      ...
      <uni-list-item
        title="技能组客服"
        clickable
        @click="startWorkGroupChatNoHistory()"
        note="默认不显示历史消息记录"
        showArrow
      />
      <uni-list-item
      ...
      <uni-list-item
        title="技能组客服-机器人2"
        clickable
        @click="startWorkGroupChatRobotV2()"
        note="默认显示分类"
        showArrow
      />
      <uni-list-item
      ...
      <uni-list-item
        title="技能组客服-附言"
        clickable
        @click="startWorkGroupChatPostscript()"
        note="自动发送附言"
        showArrow
      />
      <uni-list-item
        title="技能组客服-自定义昵称"
        clickable
        @click="startWorkGroupChatNickname()"
        note="客服所见昵称"
        showArrow
      />
    </uni-list>
    ...
    <uni-list :border="true">
      ...
      <uni-list-item
        title="指定客服-附言"
        clickable
        @click="startAppointedChatPostscript()"
        note="自动发送附言"
        showArrow
      />
      <uni-list-item
        title="指定客服-自定义昵称"
        clickable
        @click="startAppointedChatNickname()"
        note="客服所见昵称"
        showArrow
      />
    </uni-list>
...
export default {
  ...
  methods: {
    ...
    startWorkGroupChat() {
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/chat-kf?wid=" +
          this.workGroupWid +
    ...
    startWorkGroupChatNoHistory() {
      ...
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/chat-kf?wid=" +
          this.workGroupWid +
          "&type=workGroup&aid=&title=萝卜丝&history=0",
      });
    },
    ...
    startWorkGroupChatRobotV2() {
      ...
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/chat-kf?wid=" +
          this.workGroupWidRobot +
          "&type=workGroup&aid=&title=萝卜丝&history=0&v2robot=true",
      });
    },
    ...
    startWorkGroupChatPostscript() {
      ...
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/chat-kf?wid=" +
          this.workGroupWid +
          "&type=workGroup&aid=&title=萝卜丝&postscript=这是附言自动发送给客服",
      });
    },
    startWorkGroupChatNickname() {
      ...
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/chat-kf?wid=" +
          this.workGroupWid +
          "&type=workGroup&aid=&title=萝卜丝&nickname=自定义昵称",
      });
    },
    // 一对一会话
    startAppointedChat() {
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/chat-kf?wid=&type=appointed&aid=" +
          this.agentUid +
          "&title=萝卜丝",
      });
    },
    ...
    startAppointedChatPostscript() {
      ...
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/chat-kf?wid=&type=appointed&aid=" +
          this.agentUid +
          "&title=萝卜丝&postscript=这是附言自动发送给客服",
      });
    },
    ...
    startH5Chat() {
      ...
      let url =
        "https://uni.kefux.cn/chat/h5/index.html?sub=vip&uid=201808221551193&wid=201807171659201&type=workGroup&hidenav=1&aid=&ph=ph";
      uni.navigateTo({
        url:
          "../../components/bytedesk_kefu/webview?url=" +
