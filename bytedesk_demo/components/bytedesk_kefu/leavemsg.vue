        ...
        <view class="uni-common-mt">
            <view class="uni-form-item uni-column">
                ...
                <view class="uni-input-wrapper">
                    <input v-model="mobile" class="uni-input" placeholder="手机号" />
                </view>
            </view>
        </view>
		<view class="uni-common-mt">
		    <view class="uni-form-item uni-column">
		        <view class="title"><text class="uni-form-item__title">留言</text></view>
				<view class="uni-textarea">
					<textarea v-model="content" placeholder="请输入留言内容"/>
				</view>
		    </view>
		</view>
		<button class="my-button" type="default" @click="subMit">提交</button>
    </view>
</template>
<script>
// 
	...
	methods: {
		subMit () {
			...
			function(response) {
				...
				uni.showToast({ title: '留言失败', duration: 2000 });
			})
		}
	}
}
